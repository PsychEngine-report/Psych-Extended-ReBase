...
haxelib git linc_luajit https://github.com/kittycathy233/linc_luajit --quiet #Sirox's linc_luajit (backup)
...
haxelib install hxvlc 1.9.0 --quiet #That clearly my repo
haxelib git hxcpp https://github.com/beihu235/hxcpp --quiet #Just a normal hxcpp
haxelib git lime https://github.com/Ethantobot11/lime2 --quiet #repo owner helped to fix termux problem
